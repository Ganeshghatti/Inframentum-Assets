      ...
      <div className="col-span-1 md:col-span-2 flex items-center">
        <ul className="list-inside max-md:text-xl md:text-4xl font-semibold capitalize">
          ...
          <div className="text-base font-normal space-y-4 mt-4 max-md:text-sm">
            ...
            <li>
              <span className="text-secondaryColor font-semibold text-lg">Eco-Friendly Equipment :</span>{" "}
            ...
            <li>
              <span className="text-secondaryColor font-semibold text-lg">Alternative Power Sources :</span>{" "}
